...
function processGetUsers(reply){
	console.log(reply); 
//	debugger;
	...
	var usersDiv=getobj('currentUsersDiv');
	var usersTable=getobj('currentUsersTable');
	
	if(reply.reply.length == 0) {
		usersTable.innerHTML += '<td colspan="5" class="Fmed " style="text-align: center; padding: 20px 0;">No users found</td>';
		usersDiv.style = '';
	...
	function setColumnDisplay(column, element) {
		if(!getobj(column+'Check').checked) element.style.display = 'none';
	}
